...
async function maybe_download_attachment(imgkey, event) {
  ...
  if (
    !fs.existsSync(dirbase + filebase + ".jpg") &&
    !fs.existsSync(dirbase + filebase + ".png") &&
    !fs.existsSync(dirbase + filebase + ".mp4")
  ) {
    console.log(
      "    -- File " +
        filebase +
    ...
    try {
      ...
      console.log(
        "Error downloading file for " +
          event.parent_member_display +
          ": " +
          imgkey +
          " on " +
          event.event_date
